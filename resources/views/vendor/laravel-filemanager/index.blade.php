...
<body>
  ...
  <script>
    ...
    Dropzone.options.uploadForm = {
      ...
      acceptedFiles: "{{ lcfirst(str_singular(Request::get('type'))) == 'image' ? implode(',', config('lfm.valid_image_mimetypes')) : implode(',', config('lfm.valid_file_mimetypes')) }}",
      maxFilesize: ({{ lcfirst(str_singular(Request::get('type'))) == 'image' ? config('lfm.max_image_size') : config('lfm.max_file_size') }} / 1000)
    }
  </script>
</body>
</html>
