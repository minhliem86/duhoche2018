            ...
            <div class="col-md-12">
                ...
                <ul class="to-local nopadding inline-list">
                    @if(!$country_composer->isEmpty())
                        @foreach($country_composer as $list_country)
                            @if($list_country->slug === 'my' || $list_country->slug === 'canada' || $list_country->slug === 'uc' || $list_country->slug === 'singapore' )
                ...
                <ul class="to-local nopadding inline-list">
                    @foreach($country_composer as $list_country_multi)
                        @if($list_country_multi->slug === 'lien-tuyen-my-canada' || $list_country_multi->slug === 'lien-tuyen-anh-phap' || $list_country_multi->slug === 'zealand')
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="bottom-box row">
                            @foreach($country_composer as $item_mediumcountry)
                                @if($item_mediumcountry->slug === 'lien-tuyen-my-canada' || $item_mediumcountry->slug === 'lien-tuyen-anh-phap' || $item_mediumcountry->slug === 'zealand')
                                <div class="col-xs-12 col-sm-4 nopadding">
                                    <div class="overlay-img">
                                        <div class="img-hack hack-style02" style="background:url('{!! asset($item_mediumcountry->img_url) !!}')"></div>
                                    </div>
