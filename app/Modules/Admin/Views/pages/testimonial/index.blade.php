...
@section('link')
    {!! Html::link(route('admin.testimonial.create'),'Add New',['class'=>'btn btn-primary']) !!}
      ...
      <div class="col-sm-12">
        <table class="table table-hover">
          <thead>
            <tr>
                <th>ID</th>
                <th><i class="glyphicon glyphicon-search"></i> Author</th>
                <th>Photo</th>
                <th>Title</th>
                <th>Order</th>
                <th>Status</th>
    ...
    <script>
      $(document).ready(function(){
            ...
            var table = $('table').DataTable({
                ...
                "searching": true,
                ajax: {
                    url:  '{!! route('admin.testimonial.getAjax') !!}',
                    data: function(data){
